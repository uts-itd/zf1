...
class Zend_Acl
{
     ...
     * @return Zend_Acl Provides a fluent interface
     */
    public function allow($roles = null, $resources = null, $privileges = null, Zend_Acl_Assert_Interface|null $assert = null)
    {
     ...
     * @return Zend_Acl Provides a fluent interface
     */
    public function deny($roles = null, $resources = null, $privileges = null, Zend_Acl_Assert_Interface|null $assert = null)
    {
    ...
    public function setRule($operation, $type, $roles = null, $resources = null, $privileges = null,
                            Zend_Acl_Assert_Interface|null $assert = null)
    {
     ...
     * @return boolean|null
     */
    protected function _roleDFSAllPrivileges(Zend_Acl_Role_Interface $role, Zend_Acl_Resource_Interface|null $resource = null)
    {
        $dfs = array(
            'visited' => array(),
            'stack'   => array()
     ...
     * @throws Zend_Acl_Exception
     */
    protected function _roleDFSVisitAllPrivileges(Zend_Acl_Role_Interface $role, Zend_Acl_Resource_Interface|null $resource = null,
                                                 &$dfs = null)
    {
        if (null === $dfs) {
            /**
     ...
     * @throws Zend_Acl_Exception
     */
    protected function _roleDFSOnePrivilege(Zend_Acl_Role_Interface $role, Zend_Acl_Resource_Interface|null $resource = null,
                                            $privilege = null)
    {
        if (null === $privilege) {
            /**
     ...
     * @throws Zend_Acl_Exception
     */
    protected function _roleDFSVisitOnePrivilege(Zend_Acl_Role_Interface $role, Zend_Acl_Resource_Interface|null $resource = null,
     ...
     * @return string|null
     */
    protected function _getRuleType(Zend_Acl_Resource_Interface|null $resource = null, Zend_Acl_Role_Interface|null $role = null,
                                    $privilege = null)
    {
     ...
     * @return array|null
     */
    protected function &_getRules(Zend_Acl_Resource_Interface|null $resource = null, Zend_Acl_Role_Interface|null $role = null,
                                  $create = false)
    {
