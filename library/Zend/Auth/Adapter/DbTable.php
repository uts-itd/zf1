...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
     ...
     */
    public function __construct(Zend_Db_Adapter_Abstract|null $zendDb = null, $tableName = null, $identityColumn = null,
     ...
     */
    protected function _setDbAdapter(Zend_Db_Adapter_Abstract|null $zendDb = null)
    {
        $this->_zendDb = $zendDb;
